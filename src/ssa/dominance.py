...
def _compute_dominators(entry: BasicBlock, reachable_blocks: set[BasicBlock]) -> dict[BasicBlock, set[BasicBlock]]:
    dominators: dict[BasicBlock, set[BasicBlock]] = {}
...
def _build_dominator_tree(dominators: dict[BasicBlock, set[BasicBlock]], entry: BasicBlock) -> DominatorTree:
    idom: dict[BasicBlock, Optional[BasicBlock]] = {}
